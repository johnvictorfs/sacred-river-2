...
class Item(object):
    def __init__(self, name, attack, armour, value, heal):
        self.name = name
        self.attack = attack
        self.armour = armour
        self.value = value
...
# Class Item: Name, Attack, Armour, Value, Heal #

# Weapons #
iron_sword = Item('Iron Sword', 5, 0, 8, 0)
steel_sword = Item('Steel Sword', 8, 0, 12, 0)

# Potions #
health_potion = Item('Health Potion', 0, 0, 0, 20)
